/*
	Defined Constants - http://www.caskeys.com/dc/?p=1314#Constants
	Damon V. Caskey
...
#define COLLAPSE		openborconstant("ANI_FALL2")			//Collapse
...
#define EIMPL			A_FOLLOW3								//Impact effect: Large.
#define ESPLA			A_FOLLOW4								//Impact effect: Splash.
...
#define BLOCKPAR			openborconstant("ANI_FOLLOW91")			//Parry/Just defense animation.
#define BLOCKPARA			openborconstant("ANI_FOLLOW92")			//Air Parry/Just defense animation.
#define BLOCKBRK			20										//Guard or attack broken.
#define POWUP			openborconstant("ANI_FOLLOW94")			//Power up animation.
#define CLIMBUPB		openborconstant("ANI_FOLLOW95")			//Climb up (wall/object is toward background on Z).
#define CLIMBDNB		openborconstant("ANI_FOLLOW96")			//Climb down (wall/object is toward background on Z).
#define CLIMBUP			openborconstant("ANI_FOLLOW97")			//Climb up (wall/object is toward foreground on Z).
#define CLIMBDN			openborconstant("ANI_FOLLOW98")			//Climb down (wall/object is toward foreground on Z).
#define	ICONS			openborconstant("ANI_FOLLOW100")		//Icons placeholder.
#define BACKSTEP		openborconstant("ANI_FREESPECIAL2")		//Backward dash.
...
#define T_NONE           openborconstant("TYPE_NONE")
...
#define APUSHX          93                                      //Resistance to environment push X.
#define APUSHY          94                                      //Resistance to environment push Y.
#define APUSHZ          95                                      //Resistance to environment push Z.
#define ASLIDEX         96                                      //Resistance to environment slide X.
#define ASLIDEY         97                                      //Resistance to environment slide Y.
#define ASLIDEZ         98                                      //Resistance to environment slide Z.
...
/******Keys******/
#define K_ANY			"anybutton"								//Any key.
#define K_ATK1			"attack"								//Attack 1.
#define K_ATK2			"attack2"								//Attack 2.
#define K_ATK3			"attack3"								//Attack 3.
#define K_ATK4			"attack4"								//Attack 4.
#define K_ESC			"esc"									//Escape.
#define K_JUMP			"jump"									//Jump.
#define K_MDOWN			"movedown"								//Move down.
#define K_MLEFT			"moveleft"								//Move left.
#define K_MRIGHT		"moveright"								//Move right.
#define K_MUP			"moveup"								//Move up.
#define K_SCREENSHOT	"screenshot"							//Screenshot.
#define K_SPECIAL		"special"								//Special.
#define K_START			"start"									//Start.

/******Models******/
#define EFFECT			"effe0001"								//General effect model.
#define EFFATAL			"fata0001"								//Fatality.
#define FLLAND			"landm"
#define FLLAND2			"impm"
#define FLWALLM			"wallm"									//Wall dust, medium.
...
#define SNDSKEL			271										//Hit, skeleton, light.
#define SNDSKEM			272										//Hit, skeleton, medium.
#define SNDSKEH			273										//Hit, skeleton, heavy.
...
//#define SNDEFF37		 1037									//Open.
#define SNDEFF38		1038									//GA Remake skeleton walking.
#define SNDEFF39		1039									//GA Remake skeleton fall.
#define SNDEFF40		1040									//GA Remake skeleton rise.
#define SNDEFF41		1041									//GA Remake skeleton stand up.
